  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | JB Jaafar's Barber</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop JB Jaafar's Barber in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="JB Jaafar's Barber | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="JB Jaafar's Barber | Premium Barbershop Berlin" />
        <meta
